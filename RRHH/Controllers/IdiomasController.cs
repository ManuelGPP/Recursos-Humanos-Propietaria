...
namespace RRHH.Controllers
{
    public class IdiomasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdIdioma,Nombre,Estado")] Idioma idioma)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdIdioma,Nombre,Estado")] Idioma idioma)
        {
            if (ModelState.IsValid)
            {
